 ...
 */
  ...
  *
  * This function initializes the button device and sets its initial
  * state to released. It also enables interrupts and validates the
  * button GPIO port.
  *
 ...
 /**
  * @brief Test case for a single button press.
  *
  * This test simulates a button press followed by a release and
  * checks if the events are published correctly to the zbus channel.
  */
  ...
  *
  * This test simulates a long button press (greater than the threshold)
  * and verifies that the correct event is generated and
  * published correctly.
  */
